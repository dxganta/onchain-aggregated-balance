...
contract BcrvRenWSBTCHelper is IHelper {

    ICurveExchange public constant CURVE_POOL = ICurveExchange(0x7fC77b5c7614E1533320Ea6DDc2Eb61fa00A9714);
    ...
    function getBalanceInWbtc(address _account) public view returns (uint256) {
        ...
        uint256 wbtcReserve = CURVE_POOL.balances(0) + CURVE_POOL.balances(1) +  (CURVE_POOL.balances(2) / 1e10); 
